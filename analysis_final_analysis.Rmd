...
sbsPlot = makeSideBySideDotPlot(obj.integrated, plotElems = plotElems, featureGenes=unique(c("MX1", "MX2", "XAF1", "IFI44L", "IFI44", "IFI6", "LY6E", "ISG15", "IFITM1")), group.by = "mpoint", rel.width.legend = 0.01, plot.title = "")
...
sbsPlot = makeSideBySideDotPlot(obj.integrated, plotElems = plotElems, featureGenes=unique(c("JUN", "JUNB", "FOS", "FOSB", "CCL3", "CCL4", "THEMIS2", "GZMB", "S100A8", "S100A9")), group.by = "mpoint", rel.width.legend = 0.01, plot.title = "")
sbsPlot = cowplot::plot_grid(ggdraw() + draw_label("NK-cells", fontface='bold'), sbsPlot, ncol =1, rel_heights = c(0.1,1.0))
...
p
#save_plot(p, "fuzzyplots/asympt", fig.width=12, fig.height = 8)
...
save.image("/mnt/f/dev/data/Rprojs/covidSC/analysis_end.temporal.RData", compress = FALSE)
...
```{r}
DimPlot(obj.integrated, group.by = "unified_cellnames")
...
```{r}
unique(obj.integrated$celltypenames)
```
