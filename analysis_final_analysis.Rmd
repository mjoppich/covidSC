...
```{r}
makePlotsListsGO(cd8_disease_tp.go, cd8_disease_tp, "todoplots/12/cd8/go/")

makePlotsListsGO(cd8_disease_tp.ra, cd8_disease_tp, "todoplots/12/cd8/ra/", name.ggo=NULL, name.ego="rao", name.ego_up="rao_up", name.ego_down="rao_down", name.title="ReactomePA")

makePlotsListsGSE(cd8_disease_tp.gse, cd8_disease_tp, "todoplots/12/cd8/gse/")
```
